    ...
    <div className="trainer-dashboard">
      ...
      <div className="dashboard-summary">
        <div className="summary-card">
          <span className="summary-value">{dashboardData?.stats?.totalClients || 0}</span>
          <span className="summary-label">Active Clients</span>
        </div>
        <div className="summary-card">
          <span className="summary-value">{dashboardData?.stats?.classesThisWeek || 0}</span>
          <span className="summary-label">Classes This Week</span>
        </div>
        <div className="summary-card">
          <span className="summary-value">${dashboardData?.stats?.monthlyRevenue || 0}</span>
          <span className="summary-label">Monthly Revenue</span>
        </div>
        <div className="summary-card">
          <span className="summary-value">{dashboardData?.stats?.pendingPayments || 0}</span>
                ...
                <div key={client.id} className="client-item">
                  ...
                  <div className="client-info">
                    ...
                    <div className="client-meta">
                      <span className="client-membership">{client.membershipType}</span>
