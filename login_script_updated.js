// Script de login automático actualizado
console.log('🔄 Iniciando login automático con configuración actualizada...');
console.log('📍 Cliente en puerto 5174, Backend en puerto 5004');
...
async function autoLogin() {
  try {
    ...
    console.log('🔧 Verifica que el backend esté ejecutándose en puerto 5004');
  }
}
