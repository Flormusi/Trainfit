...
import {
  ...
  Underlay,
  VideoEdit
} from "./chunk-XZ6AAI54.js";
import {
  ColorSpace,
  Delivery,
  DeliveryFormatAction
} from "./chunk-VGBHM5HB.js";
import {
  __export
  ...
  dpr(value) {
    return this.param(value, "dpr", "dpr", (dpr) => {
      ...
      if (dpr != null ? dpr.match(/^\d+$/) : void 0) {
        ...
        return expression_default2.normalize(dpr);
      }
    });
  }
  effect(value) {
...
function generateTransformationString2(transformationOptions) {
  ...
  const dpr = transformationOptions.dpr === void 0 ? transformationOptions.dpr : processDpr2(transformationOptions.dpr);
  ...
  const urlParams = {
    ...
    c: crop,
    co: color2,
    dpr: legacyNormalizeExpression2(dpr),
...
function finalize_source2(source3, format, url_suffix) {
  let source_to_sign;
...
function createCloudinaryLegacyURL2(public_id, transformationOptions) {
  ...
  [public_id, source_to_sign] = finalize_source2(public_id, format, url_suffix);
