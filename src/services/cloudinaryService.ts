...
export const exerciseImageMap: Record<string, string> = {
  ...
  'Abdominal en Polea alta': 'Abdominal_en_Polea_alta',
  'Abdominales Cortitos': 'Abdominales_Cortitos',
  'Bíceps en banco Scott (barra ez)': 'Biceps_en_banco_Scott_barra_ez',
  'Curl bíceps concentrado en muslo': 'Curl_biceps_concentrado_en_muslo',
  'Curl bíceps alterno con supinación': 'Curl_biceps_alterno_con_supinacion',
  'Desplazamiento lateral': 'Desplazamiento_lateral',
  'estiramiento piramidal/cadena posterior': 'Estiramiento_piramidal_cadena_posterior',
  // ── Nuevas imágenes Jun 2026 ──────────────────────────────
  'Aperturas mancuernas banco inclinado': 'Aperturas_mancuernas_banco_inclinado',
  'Cardio 3x1': 'Cardio_3x1',
  'Drop jump': 'Drop_jump',
  'Abdominales alternados piernas ext': 'Abdominales_alternados_piernas_ext',
  'Abdominales cruzados a pp extendida': 'Abdominales_cruzados_a_pp_extendida',
  'Abductor con banda y pelota': 'Abductor_con_banda_y_pelota',
  'Air bike': 'Air_bike',
  'Aperturas en el piso': 'Aperturas_en_el_piso',
  'Battle Rope Alternado': 'Battle_Rope_Alternado',
  'Battle rope Doble': 'Battle_rope_Doble',
  'Biceps sobre pelota': 'Biceps_sobre_pelota',
  'Caminata Lateral Banda tobillo': 'Caminata_Lateral_Banda_tobillo',
  'Cardio 30': 'Cardio_30',
  'Cargada': 'Cargada',
  'Control Pelvico Elevado': 'Control_Pelvico_Elevado',
  'Control pelvico alto': 'Control_Pelvico_Elevado',
  'Control pelvico con barra': 'Control_pelvico_con_barra',
  'Control pelvico con pelota suiza': 'Control_pelvico_con_pelota_suiza',
  'Cruces en poleas': 'Cruces_en_poleas',
  'Curl Nordico': 'Curl_Nordico',
  'Curl de biceps con barra en pronacion': 'Curl_de_biceps_con_barra_en_pronacion',
  'Desplazamiento con resistencia': 'Desplazamiento_con_resistencia',
  'Desplaz. en plancha alta': 'Desplazamiento_en_plancha_alta',
  'Dorsales en máquina': 'Dorsales_en_maquina',
  'Dorsiflexión en banco': 'Dorsiflexion_en_banco',
  'Encogimiento de hombros con barra': 'Encogimiento_de_hombros_con_barra',
  'Encogimiento de hombros con mancuernas': 'Encogimiento_de_hombros_con_mancuernas',
  'Espinal isometrico': 'Espinal_isometrico',
  'Estiramiento Piramidal': 'Estiramiento_Piramidal',
  'Rechazo Escapular': 'Rechazo_Escapular',
  'Rotación torácica en tracción': 'Rotacion_toracica_en_traccion',
