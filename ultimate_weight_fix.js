...
// Ejecutar en la consola del navegador: ultimateWeightFix.run()
...
class UltimateWeightFix {
  ...
  setupNetworkInterception() {
    ...
    window.XMLHttpRequest = function() {
      ...
      xhr.send = function(data) {
        if (this.responseURL && (this.responseURL.includes('/api/') || this.responseURL.includes('profile'))) {
  ...
  quickDiagnosis() {
    ...
    const results = {
      ...
      weightElements: document.querySelectorAll('*[textContent*="kg"]').length
    };
